...
const login = async () => {
  ...
  if (await userStore.checkAuthentication()) {
    ...
    <div class="tw-container tw-px-4 tw-mx-auto tw-relative">
      <div class="tw-max-w-lg tw-mx-auto">
        <div class="tw-text-center tw-mb-8">
          ...
          <h2 class="tw-text-3xl md:tw-text-4xl tw-font-extrabold tw-mb-2 tw-text-indigo-500">Sign in</h2>
        </div>
        <div>
          <div class="tw-mb-6">
            <label class="tw-block tw-mb-2 tw-font-extrabold" for="">{{ t('label.username') }}</label>
          ...
          <div class="tw-mb-6">
            <label class="tw-block tw-mb-2 tw-font-extrabold" for="">{{ t('label.password') }}</label>
            <input
              v-model="password"
              class="tw-inline-block tw-w-full tw-p-4 tw-leading-6 tw-text-lg tw-font-extrabold tw-placeholder-indigo-900 tw-bg-white tw-shadow tw-border-2 tw-border-indigo-900 tw-rounded"
              type="password"
